                        ...
                        <tbody>                  
                            ...
                            foreach ($team_list as $value) :
                                ...
                                <tr>  
                                    ...
                                    <td><?php echo $value['designation']; ?></td>                                                                                  <td>                                
                                        <button type="button" class="btn btn-primary btn-xs fetch-team" data-id="<?php echo $value['id']; ?>" data-bs-toggle="modal" data-bs-target="#basicModal">View</button>                     
                                    <td>     
...
<td><?php echo date("d-m-Y", strtotime($value['createdDate'])); ?></td>
  ...
  <?php             
                                     ...
                                     $res= $this->common->eachcheckpri('editt',$this->session->userdata('brw_logged_type'));
                                      if($res->num_rows() > 0){
                                      ?>
                                        <a class="btn btn-info btn-actions btn-sm"  popup="tooltip-custom" data-bs-toggle="tooltip" placement="top" title="Edit" href="<?php echo base_url(); ?>edit-team/<?php echo $value["id"]; ?>"><i class="far fa-edit font-14"></i></a>
