...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <h5 class="card-header p-0">Breaking News</h5>
        
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalAdd">Breaking News</button>
        ...
        <div class="modal-content p-1">
            <div class="modal-body">
                ...
                <form class="update-link" method="post">
                    ...
                    <label class="form-label" for="bs-validation-country">Select Article</label>
                                    <select id="blogtitle" class="form-control"  name="blog_title">
                                        <option value="">Select Article </option>

                                        <?php foreach ($article as $value) : ?>

                                            <option value="<?php echo $value['title']; ?>" name="blog_title">  <?php echo $value['title']; ?></option>
        ...
        <div class="modal-content p-1">
            <div class="modal-body">
                ...
                <form class="add-link" method="post" enctype="multipart/form-data" class="row mb-3">
                    <div class="col-12 col-md-12">
                       <label class="form-label" for="bs-validation-country">Select Article</label>
                                    <select id="" class="form-control"  name="blog_title">
                                        <option value="">Select Article </option>
