...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <h5 class="card-header p-0">Article category List</h5>
          <?php             
        ...
        <form class="update-blogcategory" method="post">                   
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">Edit Article Category</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <label class="form-label" for="modalEditUserFirstName">Article Category Name</label>

                            <input type="text" class="form-control" placeholder="Enter Article Category Name" id="cat_name" name="category_name">
...
<div class="modal fade" id="smallModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <form class="add-blogcategory" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">Add Article Category</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Article Category Name" name="category_name">
